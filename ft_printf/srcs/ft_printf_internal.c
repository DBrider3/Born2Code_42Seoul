...
/*   Updated: 2021/03/29 02:55:10 by dcho             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

int		ft_printf_scan(const char **format, va_list ap, t_options *options)
{
	int		count;
	int		i;
...
int		ft_printf_main(const char **format, va_list ap, t_options *options)
{
	int		count;
